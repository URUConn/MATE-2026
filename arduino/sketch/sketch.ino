...
const float FACTORY_ZERO_OFFSET[SENSOR_AXES] = {308.145, 0, 0, 0, 0};
...
const bool FACTORY_TWOPT_ENABLED[SENSOR_AXES] = {true, false, false, false, false};
const bool FACTORY_TWOPT_MIN_SET[SENSOR_AXES] = {true, false, false, false, false};
const bool FACTORY_TWOPT_MAX_SET[SENSOR_AXES] = {true, false, false, false, false};
const float FACTORY_TWOPT_MIN_ENC_DEG[SENSOR_AXES] = {359.91, 0, 0, 0, 0};
const float FACTORY_TWOPT_MAX_ENC_DEG[SENSOR_AXES] = {172.71, 0, 0, 0, 0};
