...
def generate_launch_description():
    ...
    actions = [
        ...
        DeclareLaunchArgument(
            'enable_thruster_node',
            default_value='false',
            description='Enable direct actuator thruster node. Keep false when using mavros_bridge_node.'
        ),
    ]
    ...
    actions.extend([
        ...
        Node(
            ...
            parameters=[config],
            output='screen',
            condition=IfCondition(LaunchConfiguration('enable_thruster_node')),
        ),
        Node(
            package='rov_onboard',
